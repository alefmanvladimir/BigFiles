...
export default function FilesSearchBox({ files, onSearch, className = '' }: FilesSearchBoxProps) {
  ...
  return (
    <form className={`join ${className}`} onSubmit={onSubmit}>
      <input className="input input-xs sm:input-sm md:input-md input-bordered join-item" placeholder="Search"
      ...
      <div className="indicator">
        ...
        <button className="btn btn-xs sm:btn-sm md:btn-md join-item btn-outline" type="submit">
          {/* magnifying-glass */}
